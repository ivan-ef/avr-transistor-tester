 ...
 *   - max. frequency of LC oscillator (L_i 82 �H / C_i 1 nF): about 600 kHz
 * ************************************************************************ */
...
Measurement ranges:
- L_i 82�H / C_i 1nF (base frequency around 595 kHz)
  ...
  C     10fF - 33nF      3.3fF - 3.5�F   0.1pF - 900nF
...
uint8_t Get_LC_Frequency(void)
{
  ...
  while (Flag)
  {
    ...
    /* * MCU cycles per �s and scale gatetime to �s */
